...
void main(void) {
    ...
    while (1) {
        ...
        switch(operation_mode)
        {
            ...
            case 0x04:
                if(conv_mode_op== 0x09)
                {
                    set_temp(key);
                    if(conv_mode_op== 0x0A)
                    {
                        continue;
                    }
                }
                else if(conv_mode_op== 0x0A)
                {
                    set_time(key);
                }
                break;
    ...
    if(reset_flag== 0x11)
    {
      ...
      if(key!='*' && key!='#' && key!=0xFF)
      {
        ...
        else if(key =='#')
        {
            ...
            while(sec !=0)
            {
                clcd_putch(sec/100 + '0', (0x90 + 12));
                clcd_putch((sec/10)%10 + '0', (0x90 + 13));
                clcd_putch(sec%10 +'0', (0x90 + 14));
            }
            TMR2ON= 0;
            clear_clcd();
            conv_mode_op = 0x0A;
